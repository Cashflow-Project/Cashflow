...
public class ShowBigDealController : MonoBehaviour
{
    public static ShowBigDealController instance;
    private void Awake(){
        instance = this;
    }
    public List<BigDealCard> heldCards = new List<BigDealCard>();
    ...
    public void RemoveCardFormShow(BigDealCard cardToRemove)
    {
    ...
    public void AddCardToShow(BigDealCard cardToAdd){
